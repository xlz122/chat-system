    ...
    return (
      ...
      <div className="left-panel" >
        ...
        >
          <div className="fillet-ico-panel close-ico">
            {leftIco&&<img
              src={require('@/static/img/close.png')}
              alt=""
            />}
          </div>
      ...
      <div className="right-panel">
        ...
        <div className="function-switching-panel">
            ...
            >
              <img
                src ={imgRequre.iconStatus.message ? messageIcoActive:messageIco}
                alt="消息"
              />
            </div>
            ...
            >
              <img
                src ={imgRequre.iconStatus.friendList ?contactIcoActive: contactIco}
                alt="好友列表"
              />
            </div>
            <div
